...
class CriticNetwork:
    def __init__(self, sess, state_dim, action_dim):
        ...
        self.state_input, self.action_input, self.q_value_output, self.net = self.create_q_network(state_dim, action_dim)
    ...
    def create_q_network(self,state_dim,action_dim):
        ...
        layer2 = tf.nn.relu(tf.matmul(layer1, state_w2) + tf.matmul(action_input, action_w2) + b2)
